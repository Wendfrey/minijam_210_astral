...
func level_1_next_level():
	...
	match (current_level):
		0:
			nodeSpacer.add_pieces(arrayFichaTipo([Ficha.Tipo.B, Ficha.Tipo.A, Ficha.Tipo.A, Ficha.Tipo.G]))
		1:
			nodeSpacer.add_pieces(arrayFichaTipo([Ficha.Tipo.B, Ficha.Tipo.C, Ficha.Tipo.B]))
		2:
			nodeSpacer.add_pieces(arrayFichaTipo([Ficha.Tipo.A, Ficha.Tipo.A]))
		3:
			nodeSpacer.add_pieces(arrayFichaTipo([Ficha.Tipo.A]))
