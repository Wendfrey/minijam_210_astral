...
func _init() -> void:
	rule_name = "[color=BLACK][img width=32]res://assets/img/TinyIconF.png[/img] can't be more than 3 spaces separated from [img width=32]res://assets/img/TinyIconC.png[/img]"
