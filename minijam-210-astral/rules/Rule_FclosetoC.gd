...
func _init() -> void:
	rule_name = "[color=BLACK][img width=32 color=BLACK]res://assets/img/TinyIconF.png[/img] can't be more than 1 space away from [img width=32 color=BLACK]res://assets/img/TinyIconC.png[/img]"
